...
export default function Dashboard() {
    ...
    const handleEventsCalendar = async () => {
        await fetchWithAuth('/api/google/calendar', {
            method: "POST",
    ...
    return (
        <div className="w-full h-full flex flex-col">
            <div className="flex flex-col justify-center items-center">
                <div className="w-[90%] space-y-6 mt-10 mx-auto">
                    <div id="header-elements" className="flex flex-col-reverse sm:flex-row justify-between items-center w-full">
                        ...
                        <div className="hidden sm:flex flex-col xs:flex-row xs:space-x-2 space-y-2 xs:space-y-0 w-full sm:w-auto">
                            ...
                            <Button
                                variant="outline"
                                className="cursor-pointer bg-zinc-200 hover:bg-zinc-700 hover:text-white w-full sm:w-auto"
                    ...
                    <div className="flex sm:hidden flex-col space-y-3 w-full mt-6">
                        <Button
                            variant="outline"
                            className="cursor-pointer bg-zinc-700 text-white hover:bg-zinc-300 hover:text-black w-full"
                            onClick={handleReset}>
                            Upload a New Syllabus
                        </Button>
                        <Button
                            variant="outline"
                            className="cursor-pointer bg-zinc-200 hover:bg-zinc-700 hover:text-white w-full"
                            onClick={handleEventsCalendar}>
                            <svg className="w-5 h-5 inline-block mr-1" viewBox="0 0 24 24">
                            <path fill="currentColor" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"/>
                            <path fill="currentColor" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z"/>
